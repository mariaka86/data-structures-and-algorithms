...
Write a function named raisedToTheThird that takes in an array of numbers Done
 returns a new array of each of those numbers
 raised to the 3rd power (hint: look up Math.pow()).
...
Write a function named addOne that, given an array of numbers Done
...
Write a function named addQuestion that, given an array of strings,
 uses map to return a new array containing
 each string followed by a question mark character.
------------------------------------------------------------------------------------------------ */

const addQuestion = (arr) => {
  return arr.map((newArray2)=> newArray2 + '?') ;
...
Write a function named forLoopTwoToThe Done
given an array of integers as input,
iterates over the array
returns a new array.
returned array should contain the result of raising 2 to the power of the original input element.
...
the same output as your forLoopTwoToThe function from challenge 4 and your
